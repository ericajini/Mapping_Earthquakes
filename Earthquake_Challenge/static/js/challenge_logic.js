...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  let majorGeo = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson"
  // 4. Use the same style as the earthquake data.

  d3.json(majorGeo).then(function(data){
  function styleInfo(feature) {
    return {
      opacity: 1,
      fillOpacity: 1,
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  let tectonicGeo = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json"
  let myStyle = {
    color: "pink",
    weight: 2.5
};
  d3.json(tectonicGeo).then(function(data) {
    L.geoJson(data, {
      style: myStyle
